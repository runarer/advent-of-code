...
def main():
    ...
    print(last_before_bottom)

    sand_fell_into_the_abyss = False

    while not sand_fell_into_the_abyss:
        # Drop new sand
        falling_sand_x = 500
        falling_sand_y = 0
        while True:
            # Fall into abyss
            if falling_sand_y > last_before_bottom:
                sand_fell_into_the_abyss = True
                break
