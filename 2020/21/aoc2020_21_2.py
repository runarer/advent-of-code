...
def main():
    ...
    english_unknown = {v:k for k,v in unknown_english.items()}
    print(english_unknown)
    ...
    sorted_allergens = list(unknown_english.values())
    sorted_allergens.sort()
    line = english_unknown[sorted_allergens[0]]
    for ingr in sorted_allergens[1:]:
        line += "," + english_unknown[ingr]
