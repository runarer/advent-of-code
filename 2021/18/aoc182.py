...
def main():
    ...
    for number1 in numbers:
        for number2 in numbers:
            if number1 == number2:
                continue
            snailfish_number = add_snailnumbers(number1,number2)
            cur_magnitude = magnitude(snailfish_number)
            if cur_magnitude > highest_magnitude:
                highest_magnitude = cur_magnitude
